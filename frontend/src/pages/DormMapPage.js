            ...
            if (user) {
              return (
                <>
                  ...
                  <button
                    onClick={() =>
                      user.status === "admin" ? navigate("/admin") : navigate("/owner")
                    }
                    style={{
                      padding: "8px 16px",
                      background: "#3b82f6",
                ...
                >
                  <Popup>
                    <div style={{ maxWidth: "200px" }}>
                      ...
                      <p>{dorm.address}</p>
                      <p>
                        <b>สิ่งอำนวยความสะดวก:</b> {renderArray(dorm.facilities)}
                      </p>
                      <p>
                        <b>ระบบความปลอดภัย:</b> {renderArray(dorm.security)}
                      </p>
        ...
        >
          ...
          >
            ...
            <div style={{ marginBottom: "12px" }}>
              ...
              <input style={input} value={selectedDorm.dormname || ""} readOnly />
            </div>

            <div style={{ marginBottom: "12px" }}>
              <label style={{ fontWeight: 600 }}>ชื่อเจ้าของหอพัก</label>
              <input style={input} value={selectedDorm.ownername || "ไม่ระบุ"} readOnly />
            </div>

            <div style={{ marginBottom: "12px" }}>
              <label style={{ fontWeight: 600 }}>เบอร์โทรศัพท์</label>
              <input style={input} value={selectedDorm.phonenumber || "ไม่ระบุ"} readOnly />
            </div>

            <div style={{ marginBottom: "12px" }}>
              <label style={{ fontWeight: 600 }}>ที่อยู่</label>
              <textarea style={textarea} value={selectedDorm.address || ""} readOnly />
            </div>

            <div style={{ marginBottom: "12px" }}>
              <label style={{ fontWeight: 600 }}>สิ่งอำนวยความสะดวก</label>
              <textarea style={textarea} value={renderArray(selectedDorm.facilities)} readOnly />
            </div>

            <div style={{ marginBottom: "12px" }}>
              <label style={{ fontWeight: 600 }}>ระบบความปลอดภัย</label>
              <textarea style={textarea} value={renderArray(selectedDorm.security)} readOnly />
            </div>
            ...
            <div style={{ marginTop: "16px" }}>
              ...
              {(selectedDorm.rooms || []).length > 0 ? (
                (selectedDorm.rooms || []).map((r, idx) => (
                  ...
                  >
                    <input style={input} value={r.roomtype || "ไม่ระบุ"} readOnly />
                    <input
                      style={input}
                      value={r.pricemonthly ? `${r.pricemonthly} บาท/เดือน` : "ไม่ระบุ"}
                      readOnly
                    />
                    <input
                      style={input}
                      value={r.priceterm ? `${r.priceterm} บาท/เทอม` : "ไม่ระบุ"}
                      readOnly
                    />
                  </div>
                ))
